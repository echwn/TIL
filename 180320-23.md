...
- html4.01/xhtml1.0/html5
    ...
    - 밴더가 주도한 어플리케이션에 포커스를 맞춘 기술, Markup/API
    - 콘텐츠 모델 flow
...
- explorer 점유율이 높은 국내 브라우저 환경에서 아이폰의 도입으로 웹표준에 대한 인식 재고
- [CSS 테스트](http://css3test.com/)

## 2. Today I found out
- WC3 CSS 권고안을 참고해서 응용할 수 있는 것들이 많다...svg 활용 예제
